...
use Marufsharia\Hyro\Core\Events\RoleAssigned;
use Marufsharia\Hyro\Core\Events\RoleRevoked;
use Marufsharia\Hyro\Core\Events\UserSuspended;
use Marufsharia\Hyro\Core\Events\UserUnsuspended;
...
class User extends Authenticatable
{
    ...
    public function assignRole($role, $assignedBy = null): self
    {
        ...
        if (!$this->hasRole($role)) {
            ...
            // Fire hook
            \Marufsharia\Hyro\Facades\Hyro::doAction('hyro.role.assigned', $this, $role, $assignedBy);
        }
    ...
    public function removeRole($role, $removedBy = null): self
    {
        ...
        if ($this->hasRole($role)) {
            ...
            // Fire hook
            \Marufsharia\Hyro\Facades\Hyro::doAction('hyro.role.revoked', $this, $role, $removedBy);
        }
