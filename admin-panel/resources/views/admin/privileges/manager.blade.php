        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $items->pluck('category')->unique()->count() }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            <div class="flex items-center">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ number_format($items->avg('roles_count') ?? 0, 1) }}</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="relative bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-2xl z-50 my-8">
            <form wire:submit="save">
                    <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <h3 class="text-xl font-semibold text-gray-900 dark:text-white">
                                {{ $isEditing ? 'Edit Privilege' : 'Create New Privilege' }}
                            </h3>
                            <button 
                                type="button"
                    ...
                    <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700 flex justify-end space-x-3">
                        ...
                        >
                            <span wire:loading.remove wire:target="save">{{ $isEditing ? 'Update Privilege' : 'Create Privilege' }}</span>
