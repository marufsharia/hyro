...
<div class="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
    ...
    <!-- Modal panel -->
    <div class="relative inline-block w-full max-w-5xl my-4 sm:my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-800 shadow-2xl rounded-xl sm:rounded-2xl z-50 h-[60vh] flex flex-col">
