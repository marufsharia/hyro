...
<head>
    ...
    <title>{{ hyro_config('appearance.app_name', config('app.name', 'Hyro')) }} - Login</title>
    ...
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                @include('hyro::admin.auth.partials.logo', ['iconType' => 'lock'])
                ...
                <form method="POST" action="{{ route('hyro.login.submit') }}" class="space-y-6">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        @if (Route::has('hyro.password.request'))
                            <div class="text-sm">
                                <a href="{{ route('hyro.password.request') }}" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                    Forgot password?
                                </a>
                            </div>
                        @endif
                ...
                @if (Route::has('hyro.register'))
                    <div class="text-center pt-4 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="{{ route('hyro.register') }}" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                Sign up
                            </a>
                        </p>
                    </div>
