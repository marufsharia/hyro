...
<head>
    ...
    <title>{{ hyro_config('appearance.app_name', config('app.name', 'Hyro')) }} - Register</title>
    ...
    <div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="text-center">
                @include('hyro::admin.auth.partials.logo', ['iconType' => 'user-add'])
            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 space-y-6 border border-gray-200 dark:border-gray-700">
                ...
                <form method="POST" action="{{ route('hyro.register.submit') }}" class="space-y-6">
                    @csrf
                ...
                @if (Route::has('hyro.login'))
                    <div class="text-center pt-4 border-t border-gray-200 dark:border-gray-700">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <a href="{{ route('hyro.login') }}" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">
                                Sign in
                            </a>
                        </p>
                    </div>
