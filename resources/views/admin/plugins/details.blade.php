...
{{-- Hero Header with Gradient - Responsive height --}}
                    ...
                    <div>
                        <div class="flex flex-col sm:flex-row items-start space-y-3 sm:space-y-0 sm:space-x-4 md:space-x-6 mb-3 sm:mb-4">
                            ...
                            <div class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 bg-white/10 backdrop-blur-md rounded-xl sm:rounded-2xl p-2 sm:p-3 flex-shrink-0 border-2 border-white/20">
                                <img src="{{ $plugin['icon'] }}" alt="{{ $plugin['name'] }}" class="w-full h-full object-contain">
                            </div>
                            @else
                            ...
                            <div class="flex-1 min-w-0">
                                <h2 class="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2 drop-shadow-lg truncate">{{ $plugin['name'] }}</h2>
                                <p class="text-sm sm:text-base md:text-lg text-purple-100 mb-2 sm:mb-4 leading-relaxed line-clamp-2">{{ $plugin['short_description'] ?? $plugin['description'] }}</p>
                                ...
                                <div class="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 text-xs sm:text-sm">
                                    <div class="flex items-center space-x-1 sm:space-x-2 text-purple-100 truncate">
                                        ...
                                        @if($plugin['author_website'] ?? false)
                                        <a href="{{ $plugin['author_website'] }}" target="_blank" class="hover:text-white transition-colors flex-shrink-0">
                                    ...
                                    <div class="flex items-center space-x-1 sm:space-x-2 text-purple-100 truncate">
                                        ...
                                        <span class="truncate">{{ $plugin['installed_at'] ? \Carbon\Carbon::parse($plugin['installed_at'])->format('M d, Y') : 'Not installed' }}</span>
                                    </div>
                                    <div class="flex items-center space-x-1 sm:space-x-2 text-purple-100">
                                        <svg class="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex flex-row sm:flex-col items-start sm:items-end space-x-2 sm:space-x-0 sm:space-y-2 mt-3 sm:mt-0">
                                ...
                                <span class="px-3 py-1.5 sm:px-4 sm:py-2 bg-purple-500/90 backdrop-blur-sm text-white text-xs font-semibold rounded-full shadow-lg">
                                    {{ ucfirst($plugin['source']) }}
                                </span>
                                @if($plugin['download_count'] ?? 0 > 0)
            ...
            {{-- Action Buttons --}}
            <div class="flex items-center justify-between mb-8 p-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-lg">
                ...
                <div class="flex items-center space-x-3">
                    <button wire:click="healthCheck" 
                            class="px-5 py-2.5 bg-white dark:bg-gray-700 border-2 border-blue-200 dark:border-blue-800 text-blue-600 dark:text-blue-400 rounded-xl hover:bg-blue-50 dark:hover:bg-blue-900/20 text-sm font-semibold transition-all duration-200 flex items-center space-x-2">
                    ...
                    @if($plugin['is_active'])
                        <button wire:click="deactivate" 
                                class="px-5 py-2.5 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl hover:bg-gray-300 dark:hover:bg-gray-600 font-semibold transition-all duration-200">
                            Deactivate
                        </button>
                    @elseif($plugin['is_installed'])
                        <button wire:click="activate" 
                                class="px-5 py-2.5 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl hover:from-green-700 hover:to-green-800 font-semibold transition-all duration-200 shadow-lg shadow-green-500/50">
                            Activate
                        </button>
                        <button wire:click="uninstall" 
                                class="px-5 py-2.5 bg-red-600 text-white rounded-xl hover:bg-red-700 font-semibold transition-all duration-200">
                            Uninstall
                        </button>
                    @else
                        <button wire:click="install" 
                                class="px-5 py-2.5 bg-gradient-to-r from-purple-600 to-purple-700 text-white rounded-xl hover:from-purple-700 hover:to-purple-800 font-semibold transition-all duration-200 shadow-lg shadow-purple-500/50">
                            Install
                        </button>
                    @endif
                </div>
            ...
            <div class="flex-1  overflow-y-auto">
                ...
                <div x-data="{ activeTab: 'overview' }" class="mb-6 sm:mb-8">
                    <div class="border-b-2 border-gray-200 dark:border-gray-700">
                        <nav class="flex space-x-1 sm:space-x-2 overflow-x-auto scrollbar-hide -mb-px">
                            ...
                            @if($plugin['settings_schema'] && count($plugin['settings_schema']) > 0)
                            ...
                            @if(count($plugin['required_plugins']) > 0 || count($plugin['optional_plugins']) > 0)
                            ...
                            @if($plugin['source'] === 'marketplace' || isset($plugin['marketplace_data']))
                        ...
                        <div x-show="activeTab === 'overview'" class="space-y-6"
                            ...
                            <div class="p-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-600">
                                <div class="flex items-start space-x-3 mb-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-300 leading-relaxed">{{ $plugin['description'] }}</p>
                                    </div>
                                </div>
                            </div>

                            {{-- Key Features --}}
                            @if(count($plugin['key_features']) > 0)
                            <div class="p-6 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-800/50 rounded-xl border border-blue-200 dark:border-blue-800">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                    @foreach($plugin['key_features'] as $feature)
                            ...
                            <div class="p-6 bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-800/50 rounded-xl border border-purple-200 dark:border-purple-800">
                                ...
                                <ul class="space-y-2">
                                    @foreach($plugin['use_cases'] as $useCase)
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div class="p-6 bg-gradient-to-br from-green-50 to-white dark:from-green-900/20 dark:to-gray-800/50 rounded-xl border border-green-200 dark:border-green-800">
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <div class="flex justify-between">
                                            ...
                                            <span class="font-medium text-gray-900 dark:text-white">{{ $plugin['hyro_version'] }}</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600 dark:text-gray-400">PHP:</span>
                                            <span class="font-medium text-gray-900 dark:text-white">{{ $plugin['php_version'] }}</span>
                                        </div>
                                        <div class="flex justify-between">
                                            <span class="text-gray-600 dark:text-gray-400">Laravel:</span>
                                            <span class="font-medium text-gray-900 dark:text-white">{{ $plugin['laravel_version'] }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-6 bg-gradient-to-br from-orange-50 to-white dark:from-orange-900/20 dark:to-gray-800/50 rounded-xl border border-orange-200 dark:border-orange-800">
                                    ...
                                    <div class="flex items-center space-x-2">
                                        @php
                                            $impact = $plugin['performance_impact'];
                                            $color = match($impact) {
                                                'low' => 'green',
                                                'medium' => 'yellow',
                                                'high' => 'red',
                                ...
                                {{-- Dependencies --}}
                                @if(count($plugin['dependencies']) > 0)
                                <div class="p-6 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-800/50 rounded-xl border border-blue-200 dark:border-blue-800">
                                    <div class="flex items-center space-x-2 mb-4">
                                        <div class="w-8 h-8 bg-blue-100 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                                            <svg class="w-4 h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <div class="p-6 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-600">
                                    ...
                                    <code class="block p-3 bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 rounded-lg text-xs font-mono border border-gray-200 dark:border-gray-600 break-all">{{ $plugin['path'] }}</code>
                                </div>
                                @endif
                            </div>

                            {{-- Security Notes --}}
                            @if($plugin['security_notes'])
                            <div class="p-6 bg-gradient-to-br from-red-50 to-white dark:from-red-900/20 dark:to-gray-800/50 rounded-xl border border-red-200 dark:border-red-800">
                                <div class="flex items-start space-x-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed">{{ $plugin['security_notes'] }}</p>
                                    </div>
                                </div>
                            </div>
                            @endif
                        ...
                        <div x-show="activeTab === 'settings'"
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="p-8 space-y-6" wire:ignore.self>
                                    @foreach($plugin['settings_schema'] as $setting)
                                    ...
                                    <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                        <button wire:click="resetPluginSettings"
                                        ...
                                        <button wire:click="savePluginSettings('{{ $plugin['id'] }}', $wire.selectedPlugin.settings)"
                        ...
                        <div x-show="activeTab === 'dependencies'"
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="p-8 space-y-6">
                                    {{-- Required Plugins --}}
                                    @if(count($plugin['required_plugins']) > 0)
                                    <div>
                                        ...
                                        <div class="space-y-3">
                                            @foreach($plugin['required_plugins'] as $plugin)
                                    ...
                                    {{-- Optional Plugins --}}
                                    @if(count($plugin['optional_plugins']) > 0)
                                    <div>
                                        <h4 class="text-sm font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                        ...
                                        <div class="space-y-3">
                                            @foreach($plugin['optional_plugins'] as $plugin)
                                            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
                                                <div class="flex items-center space-x-3">
                                    ...
                                    {{-- Conflicts --}}
                                    @if(count($plugin['conflicts_with']) > 0)
                                    <div>
                                        <h4 class="text-sm font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                            <svg class="w-5 h-5 text-red-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="space-y-3">
                                            @foreach($plugin['conflicts_with'] as $plugin)
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="p-8 space-y-6">
                                    ...
                                    <div class="p-5 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-800/50 rounded-xl border border-blue-200 dark:border-blue-800">
                                        ...
                                        <code class="block p-3 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 rounded-lg text-xs font-mono border border-gray-200 dark:border-gray-700 break-all">{{ $plugin['path'] }}</code>
                                    </div>
                                    @endif
                                    ...
                                    <div class="p-5 bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-800/50 rounded-xl border border-purple-200 dark:border-purple-800">
                                        ...
                                        <code class="block p-3 bg-white dark:bg-gray-900 text-purple-700 dark:text-purple-400 rounded-lg text-xs font-mono border border-gray-200 dark:border-gray-700">{{ $plugin['namespace'] }}</code>
                                    </div>
                                    @endif

                                    {{-- Service Providers --}}
                                    @if(count($plugin['service_providers']) > 0)
                                    <div class="p-5 bg-gradient-to-br from-green-50 to-white dark:from-green-900/20 dark:to-gray-800/50 rounded-xl border border-green-200 dark:border-green-800">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full text-xs font-bold">
                                                {{ count($plugin['service_providers']) }}
                                            </span>
                                        </div>
                                        <div class="space-y-2">
                                            @foreach($plugin['service_providers'] as $provider)
                                    ...
                                    <div class="p-5 bg-gradient-to-br from-indigo-50 to-white dark:from-indigo-900/20 dark:to-gray-800/50 rounded-xl border border-indigo-200 dark:border-indigo-800">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="px-2 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-400 rounded-full text-xs font-bold">
                                                {{ count($plugin['migrations']) }}
                                            </span>
                                        </div>
                                        <div class="space-y-2 max-h-64 overflow-y-auto">
                                            @foreach($plugin['migrations'] as $migration)
                                            <div class="flex items-center space-x-2 p-2 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                                    ...
                                    {{-- Published Assets --}}
                                    @if(count($plugin['published_assets']) > 0)
                                    <div class="p-5 bg-gradient-to-br from-pink-50 to-white dark:from-pink-900/20 dark:to-gray-800/50 rounded-xl border border-pink-200 dark:border-pink-800">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="px-2 py-1 bg-pink-100 dark:bg-pink-900/30 text-pink-700 dark:text-pink-400 rounded-full text-xs font-bold">
                                                {{ count($plugin['published_assets']) }}
                                            </span>
                                        </div>
                                        <div class="space-y-2 max-h-64 overflow-y-auto">
                                            @foreach($plugin['published_assets'] as $asset)
                                    ...
                                    {{-- Sidebar Entries --}}
                                    @if(count($plugin['sidebar_entries']) > 0)
                                    <div class="p-5 bg-gradient-to-br from-cyan-50 to-white dark:from-cyan-900/20 dark:to-gray-800/50 rounded-xl border border-cyan-200 dark:border-cyan-800">
                                        <div class="flex items-center justify-between mb-3">
                                            ...
                                            <span class="px-2 py-1 bg-cyan-100 dark:bg-cyan-900/30 text-cyan-700 dark:text-cyan-400 rounded-full text-xs font-bold">
                                                {{ count($plugin['sidebar_entries']) }}
                                            </span>
                                        </div>
                                        <div class="space-y-2">
                                            @foreach($plugin['sidebar_entries'] as $entry)
                                            <div class="p-3 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                                                <div class="flex items-center space-x-2 mb-1">
                                                    @if($entry['icon'])
                                    ...
                                    {{-- PSR-4 Autoload --}}
                                    @if(count($plugin['psr4_namespaces']) > 0)
                                    <div class="p-5 bg-gradient-to-br from-yellow-50 to-white dark:from-yellow-900/20 dark:to-gray-800/50 rounded-xl border border-yellow-200 dark:border-yellow-800">
                                        ...
                                        <div class="space-y-2">
                                            @foreach($plugin['psr4_namespaces'] as $namespace => $path)
                                            <div class="p-3 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="px-6 py-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            ...
                                            <label class="relative inline-flex items-center cursor-pointer">
                                                <input type="checkbox" 
                                                       wire:click="toggleAutoUpdate('{{ $plugin['id'] }}')"
                                                       {{ $plugin['auto_update_enabled'] ? 'checked' : '' }}
                                                       class="sr-only peer">
                                ...
                                <div class="p-6 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            ...
                                            <div class="text-3xl font-bold text-gray-900 dark:text-white">v{{ $plugin['current_version'] }}</div>
                                        </div>
                                        
                                        @if($plugin['has_update'])
                                        <div class="text-right">
                                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-1">Latest Version</div>
                                            <div class="text-2xl font-bold text-green-600 dark:text-green-400">v{{ $plugin['latest_version'] }}</div>
                                            <button wire:click="updatePlugin('{{ $plugin['id'] }}', '{{ $plugin['latest_version'] }}')"
                                ...
                                <div class="p-8">
                                    ...
                                    <div class="space-y-4 max-h-[500px] overflow-y-auto">
                                        ...
                                        <div class="p-5 bg-gradient-to-br from-gray-50 to-white dark:from-gray-700/50 dark:to-gray-800/50 rounded-xl border-2 {{ $version->version === $plugin['current_version'] ? 'border-purple-500 dark:border-purple-400' : 'border-gray-200 dark:border-gray-700' }}">
                                            {{-- Version Header --}}
                                            <div class="flex items-start justify-between mb-3">
                                                <div class="flex items-center space-x-3">
                                                    <div class="text-2xl font-bold text-gray-900 dark:text-white">v{{ $version->version }}</div>
                                                    
                                                    @if($version->version === $plugin['current_version'])
                                                ...
                                                <div class="text-right">
                                                    ...
                                                    @if($version->version !== $plugin['current_version'])
                                                    <button wire:click="rollbackPlugin('{{ $plugin['id'] }}', '{{ $version->version }}')"
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="px-6 py-4 bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        ...
                                        {{-- Export Button --}}
                                        <button wire:click="exportPluginLogs('{{ $plugin['id'] }}', 'csv')"
                                ...
                                {{-- Last Activity Info --}}
                                @if(isset($plugin['last_activated_by']) || isset($plugin['last_deactivated_by']))
                                <div class="p-6 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="grid grid-cols-2 gap-6">
                                        @if(isset($plugin['last_activated_by']))
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <div class="font-bold text-gray-900 dark:text-white">{{ $plugin['last_activated_by']['name'] ?? 'Unknown' }}</div>
                                                <div class="text-xs text-gray-500 dark:text-gray-400">{{ $plugin['last_activated_by']['time'] ?? 'N/A' }}</div>
                                            </div>
                                        </div>
                                        @endif
                                        
                                        @if(isset($plugin['last_deactivated_by']))
                                        <div class="flex items-start space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <div class="font-bold text-gray-900 dark:text-white">{{ $plugin['last_deactivated_by']['name'] ?? 'Unknown' }}</div>
                                                <div class="text-xs text-gray-500 dark:text-gray-400">{{ $plugin['last_deactivated_by']['time'] ?? 'N/A' }}</div>
                                            </div>
                                        </div>
                                        @endif
                                    </div>
                                ...
                                <div class="p-8 space-y-6">
                                    ...
                                    <div class="p-6 bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-800/50 rounded-xl border border-purple-200 dark:border-purple-800">
                                        ...
                                        <div class="grid grid-cols-3 gap-4">
                                            <div class="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
                                                <div class="text-3xl font-bold text-purple-600 dark:text-purple-400">{{ $plugin['usage_stats']['total_activations'] ?? 0 }}</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Total Activations</div>
                                            </div>
                                            <div class="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
                                                <div class="text-3xl font-bold text-blue-600 dark:text-blue-400">{{ $plugin['usage_stats']['config_changes'] ?? 0 }}</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Config Changes</div>
                                            </div>
                                            <div class="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
                                                <div class="text-3xl font-bold text-green-600 dark:text-green-400">{{ $plugin['usage_stats']['error_count'] ?? 0 }}</div>
                                    ...
                                    {{-- Activity Logs --}}
                                    @if(isset($plugin['activity_logs']) && count($plugin['activity_logs']) > 0)
                                    <div>
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                            ...
                                            <span class="ml-2 px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400 rounded-full text-xs font-bold">
                                                {{ count($plugin['activity_logs']) }}
                                            </span>
                                        </h4>
                                        
                                        <div class="space-y-3 max-h-[600px] overflow-y-auto">
                                            @foreach($plugin['activity_logs'] as $log)
                                        ...
                                        {{-- Pagination Info --}}
                                        @if(isset($plugin['activity_pagination']))
                                        <div class="mt-4 flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                            <div class="text-sm text-gray-600 dark:text-gray-400">
                                                Showing {{ $plugin['activity_pagination']['from'] ?? 0 }} to {{ $plugin['activity_pagination']['to'] ?? 0 }} 
                                                of {{ $plugin['activity_pagination']['total'] ?? 0 }} entries
                                            </div>
                                            @if(($plugin['activity_pagination']['total'] ?? 0) > ($plugin['activity_pagination']['per_page'] ?? 20))
                                            <div class="flex items-center space-x-2">
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="px-6 py-4 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <button wire:click="runPluginDiagnostics('{{ $plugin['id'] }}')"
                                        ...
                                        <div>
                                            ...
                                            <div class="flex items-center space-x-3">
                                                <div class="text-5xl font-bold 
                                                            {{ $plugin['health_score'] >= 80 ? 'text-green-600 dark:text-green-400' : '' }}
                                                            {{ $plugin['health_score'] >= 50 && $plugin['health_score'] < 80 ? 'text-yellow-600 dark:text-yellow-400' : '' }}
                                                            {{ $plugin['health_score'] < 50 ? 'text-red-600 dark:text-red-400' : '' }}">
                                                    {{ $plugin['health_score'] }}
                                                </div>
                                ...
                                <div class="p-8 space-y-6">
                                    ...
                                    <div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            @foreach($plugin['health_checks'] as $check)
                                    ...
                                    {{-- Performance Metrics --}}
                                    @if(isset($plugin['performance_metrics']))
                                    <div class="p-6 bg-gradient-to-br from-purple-50 to-white dark:from-purple-900/20 dark:to-gray-800/50 rounded-xl border border-purple-200 dark:border-purple-800">
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                            <svg class="w-5 h-5 mr-2 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/>
                                        ...
                                        <div class="grid grid-cols-3 gap-4">
                                            <div class="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
                                                <div class="text-3xl font-bold text-purple-600 dark:text-purple-400">{{ $plugin['performance_metrics']['memory_usage'] ?? 'N/A' }}</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Memory Usage</div>
                                            </div>
                                            <div class="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
                                                <div class="text-3xl font-bold text-blue-600 dark:text-blue-400">{{ $plugin['performance_metrics']['load_time'] ?? 'N/A' }}</div>
                                                <div class="text-sm text-gray-600 dark:text-gray-400 mt-1">Load Time</div>
                                            </div>
                                            <div class="p-4 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 text-center">
                                                <div class="text-3xl font-bold text-green-600 dark:text-green-400">{{ $plugin['performance_metrics']['cache_hit_rate'] ?? 'N/A' }}</div>
                                    ...
                                    {{-- Recommendations --}}
                                    @if(isset($plugin['health_recommendations']) && count($plugin['health_recommendations']) > 0)
                                    <div class="p-6 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-gray-800/50 rounded-xl border border-blue-200 dark:border-blue-800">
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                            <svg class="w-5 h-5 mr-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"/>
                                        ...
                                        <ul class="space-y-3">
                                            @foreach($plugin['health_recommendations'] as $recommendation)
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="px-6 py-4 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center justify-between">
                                        ...
                                        @if(isset($plugin['marketplace_data']['marketplace_url']))
                                        <a href="{{ $plugin['marketplace_data']['marketplace_url'] }}" target="_blank"
                                ...
                                @if(isset($plugin['marketplace_data']))
                                <div class="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                                        ...
                                        <div class="text-center">
                                            ...
                                            <div class="text-4xl font-bold text-indigo-600 dark:text-indigo-400">
                                                @if(isset($plugin['marketplace_data']['price']))
                                                    {{ $plugin['marketplace_data']['price'] === 0 ? 'Free' : '$' . number_format($plugin['marketplace_data']['price'], 2) }}
                                                @else
                                                    N/A
                                                @endif
                                            </div>
                                            @if(isset($plugin['marketplace_data']['subscription_type']))
                                            <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                                {{ ucfirst($plugin['marketplace_data']['subscription_type']) }}
                                            </div>
                                            @endif
                                        </div>
                                        
                                        {{-- Support Expiration --}}
                                        @if(isset($plugin['marketplace_data']['support_expires_at']))
                                        <div class="text-center">
                                            <div class="text-sm text-gray-600 dark:text-gray-400 mb-2">Support Expires</div>
                                            <div class="text-2xl font-bold text-gray-900 dark:text-white">
                                                {{ \Carbon\Carbon::parse($plugin['marketplace_data']['support_expires_at'])->format('M d, Y') }}
                                            </div>
                                            <div class="text-xs mt-1">
                                                @php
                                                    $daysLeft = \Carbon\Carbon::parse($plugin['marketplace_data']['support_expires_at'])->diffInDays(now());
                                                    $expired = \Carbon\Carbon::parse($plugin['marketplace_data']['support_expires_at'])->isPast();
                                                @endphp
                                                @if($expired)
                                        ...
                                        <div class="text-center flex flex-col justify-center">
                                            @if(isset($plugin['marketplace_data']['can_renew']) && $plugin['marketplace_data']['can_renew'])
                                            <button wire:click="renewPluginSubscription('{{ $plugin['id'] }}')"
                                ...
                                <div class="p-8 space-y-6">
                                    ...
                                    @if(isset($plugin['marketplace_data']['license_key']))
                                    <div class="p-6 bg-gradient-to-br from-green-50 to-white dark:from-green-900/20 dark:to-gray-800/50 rounded-xl border border-green-200 dark:border-green-800">
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                            <svg class="w-5 h-5 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        ...
                                        <div class="flex items-center space-x-3">
                                            <code class="flex-1 p-4 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 rounded-lg text-sm font-mono border border-gray-200 dark:border-gray-700">
                                                {{ $plugin['marketplace_data']['license_key'] }}
                                            </code>
                                            <button onclick="navigator.clipboard.writeText('{{ $plugin['marketplace_data']['license_key'] }}')"
                                        ...
                                        @if(isset($plugin['marketplace_data']['license_status']))
                                        <div class="mt-3 flex items-center space-x-2">
                                            <span class="text-sm text-gray-600 dark:text-gray-400">Status:</span>
                                            <span class="px-3 py-1 rounded-full text-xs font-bold
                                                        {{ $plugin['marketplace_data']['license_status'] === 'active' ? 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-400' : '' }}
                                                        {{ $plugin['marketplace_data']['license_status'] === 'expired' ? 'bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400' : '' }}
                                                        {{ $plugin['marketplace_data']['license_status'] === 'suspended' ? 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400' : '' }}">
                                                {{ strtoupper($plugin['marketplace_data']['license_status']) }}
                                            </span>
                                        </div>
                                        @endif
                                    </div>
                                    ...
                                    {{-- Purchase History --}}
                                    @if(isset($plugin['marketplace_data']['purchase_history']) && count($plugin['marketplace_data']['purchase_history']) > 0)
                                    <div>
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                            <svg class="w-5 h-5 mr-2 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                                        ...
                                        <div class="space-y-3">
                                            @foreach($plugin['marketplace_data']['purchase_history'] as $purchase)
                                    ...
                                    {{-- Reviews & Ratings --}}
                                    @if(isset($plugin['marketplace_data']['reviews']) && count($plugin['marketplace_data']['reviews']) > 0)
                                    <div class="p-6 bg-gradient-to-br from-yellow-50 to-white dark:from-yellow-900/20 dark:to-gray-800/50 rounded-xl border border-yellow-200 dark:border-yellow-800">
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                            ...
                                            <span class="ml-2 px-2 py-1 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-400 rounded-full text-xs font-bold">
                                                {{ $plugin['marketplace_data']['average_rating'] ?? 'N/A' }} â˜…
                                            </span>
                                        </h4>
                                        <div class="space-y-4 max-h-96 overflow-y-auto">
                                            @foreach($plugin['marketplace_data']['reviews'] as $review)
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        {{-- Documentation --}}
                                        @if(isset($plugin['marketplace_data']['documentation_url']))
                                        <a href="{{ $plugin['marketplace_data']['documentation_url'] }}" target="_blank"
                                        ...
                                        {{-- Support Ticket --}}
                                        @if(isset($plugin['marketplace_data']['support_url']))
                                        <a href="{{ $plugin['marketplace_data']['support_url'] }}" target="_blank"
                                        ...
                                        {{-- FAQ --}}
                                        @if(isset($plugin['marketplace_data']['faq_url']))
                                        <a href="{{ $plugin['marketplace_data']['faq_url'] }}" target="_blank"
                                    ...
                                    {{-- Similar Plugins --}}
                                    @if(isset($plugin['marketplace_data']['similar_plugins']) && count($plugin['marketplace_data']['similar_plugins']) > 0)
                                    <div>
                                        <h4 class="text-lg font-bold text-gray-900 dark:text-white mb-4 flex items-center">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            @foreach($plugin['marketplace_data']['similar_plugins'] as $similar)
                                ...
                                <div class="flex flex-col lg:flex-row">
                                    ...
                                    <div x-show="showMarkdown" 
                                        ...
                                        <div class="relative">
                                            ...
                                            <pre class="bg-gray-900 dark:bg-gray-950 text-gray-100 p-4 rounded-xl overflow-x-auto text-sm font-mono border border-gray-700"><code>{{ $plugin['readme'] }}</code></pre>
                                        </div>
                                    </div>
                                    ...
                                    <div x-show="!showMarkdown" 
                                        ...
                                        <div class="prose prose-sm sm:prose lg:prose-lg dark:prose-invert w-full
                                            ...
                                            {!! \Illuminate\Support\Str::markdown($plugin['readme']) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="px-4 sm:px-6 py-4 bg-gray-50 dark:bg-gray-700/50 border-t border-gray-200 dark:border-gray-700">
                                    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between space-y-2 sm:space-y-0 text-sm">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            @if($plugin['documentation_url'] ?? false)
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="p-8 max-h-[600px] overflow-y-auto">
                                    <div class="prose prose-sm sm:prose lg:prose-lg dark:prose-invert max-w-none
                                        ...
                                        {!! \Illuminate\Support\Str::markdown($plugin['changelog']) !!}
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
                                ...
                                <div class="px-6 py-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 border-b border-gray-200 dark:border-gray-700">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm text-gray-600 dark:text-gray-400">{{ count($plugin['screenshots']) }} image(s)</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="p-8">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        @foreach($plugin['screenshots'] as $index => $screenshot)
                                        ...
                                        <div class="p-4 sm:p-5 bg-white dark:bg-gray-900 rounded-lg border-2 border-orange-200 dark:border-orange-800 hover:border-orange-400 dark:hover:border-orange-600 transition-colors">
                                            <div class="flex items-start space-x-3 mb-3">
                                                ...
                                                <div class="flex-1">
                                                    ...
                                                    <button wire:click="clearPluginCache('{{ $plugin['id'] }}')"
                                    ...
                                    <div class="inline-block w-full max-w-md my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-800 shadow-2xl rounded-2xl relative z-10">
                                        <div class="p-6">
                                            ...
                                            <p class="text-sm text-gray-600 dark:text-gray-300 text-center mb-6">
                                                ...
                                                <span class="font-bold text-red-600 dark:text-red-400">{{ $plugin['name'] }}</span>
                                            </p>
                                            ...
                                            <div class="flex items-center justify-end space-x-3">
                                                ...
                                                <button @click="if(confirmText === '{{ $plugin['name'] }}') { 
                                                            $wire.executeDangerousAction('{{ $plugin['id'] }}', dangerAction); 
                                                            showDangerConfirm = false; 
                                                            confirmText = ''; 
                                                        }"
                                                        :disabled="confirmText !== '{{ $plugin['name'] }}'"
                                                        :class="confirmText === '{{ $plugin['name'] }}' ? 'bg-red-600 hover:bg-red-700' : 'bg-gray-400 cursor-not-allowed'"
                ...
                <div class="flex items-center justify-between pt-8 border-t-2 border-gray-200 dark:border-gray-700">
                    ...
                    <div class="flex items-center space-x-3">
                                 {{-- Back Button --}}
                            <div class="mb-1">
                                <a href="{{ route('hyro.admin.plugins.index') }}" class="inline-flex items-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white transition-colors">
                        ...
                        @if($plugin['is_installed'])
                            ...
                            @endif
                            <button wire:click="uninstall('{{ $plugin['id'] }}', true)" 
                                    wire:loading.attr="disabled"
                                    wire:target="uninstall('{{ $plugin['id'] }}', true)"
...
<div class="container mx-auto px-4 py-8">
    <div class="text-center py-12">
        <p class="text-gray-500 dark:text-gray-400">Plugin not found</p>
        <a href="{{ route('hyro.admin.plugins.index') }}" class="mt-4 inline-block text-purple-600 hover:text-purple-700">
            Back to Plugins
        </a>
    </div>
</div>
