<div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
    ...
    <form action="{{ route('hyro.admin.settings.update.rbac') }}" method="POST" class="p-6 space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="text" id="default_role" name="default_role" 
                ...
                placeholder="user">
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Role automatically assigned to new users</p>
        </div>
        ...
        <div>
            ...
            <input type="text" id="super_admin_role" name="super_admin_role" 
                value="{{ $settings['super_admin_role'] }}"
                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div>
            <label class="flex items-center cursor-pointer">
                <input type="hidden" name="cache_permissions" value="0">
                <input type="checkbox" name="cache_permissions" value="1" 
                    {{ $settings['cache_permissions'] ? 'checked' : '' }}
                    class="sr-only peer">
                <div class="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-blue-600"></div>
