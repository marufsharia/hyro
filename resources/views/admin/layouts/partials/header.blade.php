<header class="sticky top-0 z-40 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
    <div class="flex items-center justify-between h-16 px-6">
            ...
            <div class="relative flex-1 max-w-2xl" x-data="{ showResults: @entangle('showResults') }">
                <div class="relative">
                    ...
                    <input 
                        ...
                        placeholder="Search features, plugins, settings... (Ctrl+K)"
                ...
                >
                    <div class="p-2">
                        ...
                        <a 
                            href="{{ $result['url'] }}"
                            class="flex items-center px-4 py-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors group"
        ...
        <div class="flex items-center space-x-4">
            ...
            <!-- Notifications -->
            <button class="p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors relative">
    ...
    <script>
        document.addEventListener('keydown', function(e) {
            if ((e.ctrlKey || e.metaKey) && e.key === 'k') {
                e.preventDefault();
                document.querySelector('input[placeholder*="Ctrl+K"]')?.focus();
            }
        });
    </script>
</header>
